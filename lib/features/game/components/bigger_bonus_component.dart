...
class BiggerBonus extends PositionComponent
  ...
  Future<void> onLoad() async {
    ...
    _iconPainter.text = TextSpan(
      text: String.fromCharCode(Icons.straighten.codePoint),
      style: TextStyle(
        fontSize: size.x * 0.7,
        fontFamily: Icons.straighten.fontFamily,
        package: Icons.straighten.fontPackage,
        color: Colors.black,
      ),
    );
    _iconPainter.layout();
