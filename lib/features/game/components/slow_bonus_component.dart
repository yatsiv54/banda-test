...
class SlowBonus extends PositionComponent
  ...
  Future<void> onLoad() async {
    ...
    _iconPainter.text = TextSpan(
      text: String.fromCharCode(Icons.speed.codePoint),
      style: TextStyle(
        fontSize: size.x * 0.7,
        fontFamily: Icons.speed.fontFamily,
        package: Icons.speed.fontPackage,
        color: Colors.white,
      ),
    );
    _iconPainter.layout();
